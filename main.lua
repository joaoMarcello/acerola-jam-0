...
function love.load()
    ...
    _G.SCREEN_WIDTH = 398 --398
    _G.SCREEN_HEIGHT = 224
    ...
    JM:get_font():set_font_size(6)
    JM:get_font():set_color(JM_Utils:get_rgba3("664433"))
    JM.esc_to_quit = true
    ...
    return JM:load_initial_state("scripts.gamestate.game", false)
